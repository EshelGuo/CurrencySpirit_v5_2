...
public class NightSmartTabLayout extends SmartTabLayout implements INight{
	public NightSmartTabLayout(Context context) {
		super(context);
	}

	public NightSmartTabLayout(Context context, AttributeSet attrs) {
		super(context, attrs);
	}

	public NightSmartTabLayout(Context context, AttributeSet attrs, int defStyle) {
